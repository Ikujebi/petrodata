        ...
        <div key={i} className="flex mb-2 text-[.5rem]">
          <div className="flex justify-between w-full">
            <section>
              ...
              <article className="font-thin text-white text-[.4rem]">{fuel.full}</article>
            </section>
            ...
            <section className="flex flex-col justify-end items-end">
              ...
              <p className={`flex font-light ${fuel.changeColor} items-start text-[.5rem]`}>{selected ? fuel.change[selected] : fuel.change["PMS"]}</p>
            </section>
          </div>
        </div>
      ))}
